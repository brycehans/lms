...
revoke execute on function public.create_booking(is_bookable_start_time, text) from public, anon;

grant execute on function public.create_booking(is_bookable_start_time, text) to authenticated;
